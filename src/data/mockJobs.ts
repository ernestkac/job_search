...
export const INITIAL_CANDIDATE_PROFILE = {
  ...
  technicalSkills: {
    ...
    databasesAndSQL: [
      ...
      "T-SQL / PL-SQL Query Optimization",
    ],
    cybersecurity: [
  ...
  projects: [
    {
      ...
      description:
        "Designed a full-stack web application allowing IT staff to track hardware inventory, log helpdesk tickets, and run SQL maintenance reports.",
